            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="uploads/product/{{$product_pro->product_image}}" title="{{$product_pro->product_name}}" width="150" height="200"></td>
                        ...
                        <td>
                            <a href="{{URL::to('/edit-product/'.$product_pro->product_id)}}" class="active styling-edit"  ui-toggle-class="">
                                <i class="fa fa-pencil-square-o text-success text-active" title="Sửa"></i>
                            </a>
                            <a onclick="return confirm('Are you sure to delete?')" href="{{URL::to('/delete-product/'.$product_pro->product_id)}}" class="active styling-edit" ui-toggle-class="">
